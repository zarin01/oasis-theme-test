 ...
 * Oasis Pro.
 *
 * This file defines helper functions used elsewhere in the Oasis Pro Theme.
 *
 * @package oasis
 * @author  StudioPress
 ...
 */
function oasis_customizer_get_default_link_color() {
	return '#0066cc';
}
 ...
 */
function oasis_customizer_get_default_accent_color() {
	return '#0066cc';
}
 ...
 */
function oasis_customizer_get_default_footer_start_color() {
	return '#0066cc';
}
 ...
 */
function oasis_customizer_get_default_footer_end_color() {
	return '#02cbfb';
}
 ...
 */
function oasis_customizer_get_default_search_setting() {
	return 1;
}
 ...
 * @since 1.2.0
 */
function oasis_get_default_footer_logo() {
 ...
 * @since 1.0.0
 */
function oasis_get_header_search_toggle() {
	return sprintf( '<a href="#header-search-wrap" aria-controls="header-search-wrap" aria-expanded="false" role="button" class="toggle-header-search"><span class="screen-reader-text">%s</span><span class="ionicons ion-ios-search"></span></a>', __( 'Show Search', 'oasis-pro' ) );
}
 ...
 * @since 1.0.0
 */
function oasis_do_header_search_form() {

	$button = sprintf( '<a href="#" role="button" aria-expanded="false" aria-controls="header-search-wrap" class="toggle-header-search close"><span class="screen-reader-text">%s</span><span class="ionicons ion-ios-close"></span></a>', __( 'Hide Search', 'oasis-pro' ) );
 ...
 */
function oasis_color_contrast( $color ) {
 ...
 */
function oasis_color_brightness( $color, $change ) {
 ...
 * @return string Hex code for the adjusted color brightness.
 */
function oasis_change_brightness( $color ) {
	...
	return ( $luminosity > 128 ) ? oasis_color_brightness( '#000000', 20 ) : oasis_color_brightness( '#ffffff', -50 );
